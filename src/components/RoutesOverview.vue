    ...
    <div class="w-full md:max-w-[520px] md:mx-auto">
      ...
      >
        <li 
          ...
          tabindex="0"
          class="relative w-full rounded-xl min-h-[44px] p-4 cursor-pointer transition-all duration-200 overflow-hidden flex items-start focus:outline-none focus:ring-2 focus:ring-[#d4a574]"
          :class="[
